...
const products = [
  /*
   new product({
    imgePath :'/images/doliprane-1000mg-tablets-8.jpg ',
    productName : 'doli',
    information : {
        utilisation : 'Douleur légère à modérée Etat fébrile',
          Quantum : 8,
        quantite: '1000mg' ,
        consigne : 'Cette présentation est réservée à ladulte et à lenfant à partir de 27 kg (soit à partir environ 8 ans)',
    }  ,
    price :12000 
