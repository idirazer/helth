  ...
  var s = function () {
    function s(t) {
     ...
     if (i(this, s), this.element = t, this.options = Object.assign({}, {
       ...
       navigation: !0,
       infinite: !1
      }, o), this.options.loop && this.options.infinite) throw new Error("Un carousel ne peut Ãªtre Ã  la fois en boucle et en infinie");
     ...
     }), this.options.infinite && (this.offset = this.options.slidesVisible + this.options.slidesToScroll, this.offset > r.length && console.error("Vous n'avez pas assez d'Ã©lÃ©ment dans le carousel", t), this.items = [].concat(e(this.items.slice(this.items.length - this.offset).map(function (t) {
